...
export default function ChukyXiterUpdateIp() {
  ...
  return (
    <div
      ...
      style={{
        background: "#080000",
        backgroundImage:
          "radial-gradient(circle at 50% 0%, rgba(220,38,38,0.15) 0%, transparent 50%), linear-gradient(rgba(220,38,38,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(220,38,38,0.03) 1px, transparent 1px)",
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              >
                CHUKY<span className="text-red-600">XITER</span>
              </span>
            </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="pt-4 space-y-3">
                <a
                  href="https://chat.whatsapp.com/DehRxWBYLauLh4fW4I5jUF?mode=hqctcli"
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  onMouseEnter={(e) => {
                    ...
                    (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 0 30px rgba(37,211,102,0.5)";
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLAnchorElement).style.transform = "translateY(0)";
                    (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 0 20px rgba(37,211,102,0.3)";
                  }}
                >
      ...
      <footer className="mt-12 py-8 border-t text-center" style={{ borderColor: "rgba(220,38,38,0.2)" }}>
        <p className="text-[10px] tracking-[0.4em] uppercase text-muted-foreground font-mono">
          CHUKY XITER PROXY SYSTEM &copy; 2026 // SECURE CONNECTION
        </p>
      </footer>
    </div>
  );
