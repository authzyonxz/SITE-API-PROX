      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <section>
              ...
              >
                <div className="space-y-4">
                  <div>
                    <label className="block text-xs font-bold tracking-widest uppercase mb-2 font-mono" style={{ color: "rgba(96,165,250,0.8)" }}>Sua Key ARAAO</label>
                    <div className="relative group">
                      <Key className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors" style={{ color: "rgba(30,64,175,0.5)" }} />
                      <input
                        type="text"
                        value={keyInput}
                        ...
                        style={{ background: "rgba(0,0,0,0.5)", borderColor: "rgba(30,64,175,0.3)", color: "rgba(255,255,255,0.95)" }}
                      />
                    </div>
                  </div>
                  <div>
                    <label className="block text-xs font-bold tracking-widest uppercase mb-2 font-mono" style={{ color: "rgba(96,165,250,0.8)" }}>Novo Endereço de IP</label>
                    <div className="relative group">
                      <Globe className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors" style={{ color: "rgba(30,64,175,0.5)" }} />
                      <input
                        type="text"
                        value={newIp}
                  ...
                  <button onClick={handleFetchIp} disabled={isFetchingIp} className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest transition-colors hover:text-blue-400 disabled:opacity-50" style={{ color: "rgba(96,165,250,0.6)" }}>
                ...
                <button
                  ...
                  style={{ background: "linear-gradient(135deg, #1e40af 0%, #3b82f6 100%)", color: "white", boxShadow: "0 4px 20px rgba(30,64,175,0.4)" }}
                >
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="rounded-xl border overflow-hidden" style={{ borderColor: "rgba(30,64,175,0.3)", background: "rgba(30,64,175,0.02)" }}>
              <div className="px-6 py-4 border-b flex items-center justify-between" style={{ background: "rgba(30,64,175,0.1)", borderColor: "rgba(30,64,175,0.3)" }}>
                <h2 className="font-orbitron font-bold text-sm tracking-widest uppercase text-blue-400">Configurações Proxy</h2>
              </div>
                  ...
                  <div key={idx} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      {proxy.items.map((item, iidx) => (
                        <div key={iidx} className="group p-4 rounded-lg border bg-black/60 transition-all hover:border-blue-500/50" style={{ borderColor: "rgba(30,64,175,0.2)" }}>
            ...
            <div className="p-6 rounded-xl border bg-gradient-to-br from-blue-900/20 to-transparent space-y-4" style={{ borderColor: "rgba(30,64,175,0.3)" }}>
              <h3 className="font-orbitron font-bold text-xs tracking-widest uppercase text-blue-400">Suporte Araao</h3>
              <a href="https://discord.gg/YkTMhzFks" target="_blank" rel="noopener noreferrer" className="w-full py-3 rounded-lg border border-blue-500/50 bg-blue-500/10 flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-widest text-blue-400 hover:bg-blue-500/20 transition-all">
