            ...
            <section>
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button onClick={handleFetchIp} disabled={isFetchingIp} className="text-xs font-bold uppercase tracking-widest text-purple-400/60 hover:text-purple-400 transition-colors flex items-center gap-1">
                ...
                <button
                  ...
                  style={{ background: "linear-gradient(135deg, #a855f7 0%, #6b21a8 100%)", boxShadow: "0 0 20px rgba(147,51,234,0.3)", color: "#ffffff" }}
                >
            ...
            <div className="sticky top-24 space-y-6">
              ...
              {proxyInfos.map((proxy, idx) => (
                <div key={idx} className="rounded-xl overflow-hidden border" style={{ borderColor: "rgba(147,51,234,0.3)", background: "rgba(147,51,234,0.02)" }}>
                  <div className="px-5 py-3 border-b bg-purple-600/10 border-purple-600/20">
                    <h3 className="text-sm font-black tracking-widest font-orbitron text-purple-600">{proxy.title}</h3>
                  </div>
