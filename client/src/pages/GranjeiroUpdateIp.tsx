        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-3">
                <Info className="w-6 h-6" style={{ color: "#ff0000" }} />
                <h2
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  {
                    step: "1",
                    title: "Baixar Granjeiro Cert",
                    desc: (
                      <>
                        Clique no botão no topo da página para baixar o arquivo{" "}
                        <b>Granjeiro Cert.pem</b>. Este certificado é necessário para que o proxy
                  ...
                  >
                    <div
                      ...
                      style={{ background: "rgba(255,0,0,0.3)", color: "#ffffff" }}
                    >
                      {item.step}
                    </div>
                    <h3
