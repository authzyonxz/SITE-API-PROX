    ...
    >
            ...
            <section>
              ...
              >
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative group">
                      <Key className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors" style={{ color: "rgba(255,0,0,0.5)" }} />
                      <input
                        type="text"
                        value={keyInput}
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      <Globe className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors" style={{ color: "rgba(255,0,0,0.5)" }} />
                      <input
                        type="text"
                        value={newIp}
                ...
                <button
                  ...
                  style={{ background: "linear-gradient(135deg, #cc0000 0%, #ff0000 100%)", boxShadow: "0 0 20px rgba(255,0,0,0.3)", color: "#ffffff" }}
                >
      ...
      <footer className="mt-12 py-8 border-t text-center border-red-500/20">
        <p className="text-[10px] tracking-[0.4em] uppercase text-muted-foreground font-mono">
          Apple iOS Proxy System &copy; 2026 // Secure Connection Established
        </p>
      </footer>
    </div>
  );
